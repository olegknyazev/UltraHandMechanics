...
AUltraHandMechanicsCharacter::AUltraHandMechanicsCharacter()
{
...
void AUltraHandMechanicsCharacter::NotifyControllerChanged()
{
...
void AUltraHandMechanicsCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AUltraHandMechanicsCharacter::Move);
...
void AUltraHandMechanicsCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AUltraHandMechanicsCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
